...
QT_MOC_LITERAL(1, 7, 18), // "viewerImageChanged"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 6), // "dowork"
QT_MOC_LITERAL(4, 34, 17), // "findContours_view"
QT_MOC_LITERAL(5, 52, 14) // "m_viewer_image"

    },
    "Viewer\0viewerImageChanged\0\0dowork\0"
    "findContours_view\0m_viewer_image"
};
...
void Viewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->viewerImageChanged(); break;
        case 1: _t->dowork(); break;
        case 2: _t->findContours_view(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Viewer::viewerImageChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QImage*>(_v) = _t->getViewerImage(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setViewerImage(*reinterpret_cast< QImage*>(_v)); break;
        default: break;
        }
...
// SIGNAL 0
void Viewer::viewerImageChanged()
{
